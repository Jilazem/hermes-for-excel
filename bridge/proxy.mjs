...
//  PROXY_UPSTREAM  (https://<sunucu-adı>:8799)    uzak köprü (/api/*) — ZORUNLU, örn: https://<GX10-IP>:8799
...
if (!UPSTREAM) {
  console.error("Hata: PROXY_UPSTREAM ayarlanmadı. Örnek: PROXY_UPSTREAM=https://<GX10-IP>:8799 node bridge/proxy.mjs");
